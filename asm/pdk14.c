...
int parse_instruction_pdk14(AsmContext *asm_context, char *instr)
{
    ...
    if (strcmp(table_pdk14[n].instr, instr_case) == 0)
    {
      ...
      switch (table_pdk14[n].type)
      {
        ...
        case OP_M6:
        {
          ...
          {
            print_error_range(asm_context, "Address", 0, 0x7f);
            return -1;
          }
        ...
        case OP_K11:
        {
          ...
          {
            print_error_range(asm_context, "Literal", -1024, 2047);
            return -1;
          }
