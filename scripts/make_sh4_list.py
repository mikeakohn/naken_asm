...
def get_operand(operand):
  ...
  if operand == "DREG": return "dr" + str(random.randint(1, 7))
  if operand == "XDREG": return "xd" + str(random.randint(1, 7))
  if operand == "FVREG": return "fv" + str(random.randint(1, 3))
  ...
  if operand == "AT_DISP_GBR": return "@(" + str(random.randint(1, 16) * 2) + ", GBR)"
  if operand == "AT_DISP_PC": return "@(" + str(random.randint(1, 16) * 2) + ", PC)"
  if operand == "AT_DISP_REG": return "@(" + str(random.randint(1, 16) * 2) + ", r" + str(random.randint(1, 15)) + ")"
...
for line in fp:
  ...
  if operand_type == "OP_NONE":
    ...
    print(instruction + " @(" + str(random.randint(1, 16) * 2) + ",PC)," + \
                         " r" + str(random.randint(1, 15)))
  elif operand_type == "OP_AT_DISP_REG_REG":
    print(instruction + " @(" + str(random.randint(1, 16) * 2) + "," + \
