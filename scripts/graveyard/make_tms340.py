...
for line in fp:
  ...
  if operands != "":
    ...
    for o in operands:
      if o == "rs": ops.append("OP_REG")
      elif o == "rd": ops.append("OP_REG")
      elif o == "l": ops.append("OP_L")
      elif o == "b": ops.append("OP_B")
      elif o == "xy": ops.append("OP_XY")
      elif o == "*rd": ops.append("OP_P_REG")
      elif o == "*rs": ops.append("OP_P_REG")
      elif o == "*rd.xy": ops.append("OP_P_REG_XY")
      elif o == "*rs.xy": ops.append("OP_P_REG_XY")
      elif o == "z": ops.append("OP_Z")
      elif o == "*rd(disp)": ops.append("OP_P_REG_DISP")
      elif o == "*rs(disp)": ops.append("OP_P_REG_DISP")
      elif o == "@daddress": ops.append("OP_AT_ADDR")
      elif o == "@saddress": ops.append("OP_AT_ADDR")
      elif o == "f": ops.append("OP_F")
      elif o == "-*rd": ops.append("OP_MP_REG")
      elif o == "*rd+": ops.append("OP_P_REG_P")
      elif o == "-*rs": ops.append("OP_MP_REG")
      elif o == "*rs+": ops.append("OP_P_REG_P")
  ...
  print("  { %-9s 0x%04x, 0x%04x, %d, { %-14s %-14s %s }}," % (instr, opcode, mask, count, ops[0], ops[1], ops[2]))
