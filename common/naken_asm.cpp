  ...
  for (i = 1; i < argc; i++)
  {
    if (strcmp(argv[i], "-cpu_list") == 0)
    {
      printf(
        ...
        "    F100-L, Java, LC-3, MIPS, MSP430, PDK13, PDK14, PDK15, PIC14,\n"
        "    PIC18, PIC24, PIC32, Playstation 2 EE, PowerPC, Propeller,\n"
        "    Propeller 2, PSoC, M8C, RISC-V, SH-4, STM8, SuperFX, SWEET16,\n"
        "    unSP, THUMB, TMS1000, TMS1100, TMS340, TMS9900, WebAssembly,\n"
        "    Xtensa, Z80\n");
      exit(0);
    }
