...
struct _cpu_list cpu_list[] =
{
...
#endif
#ifdef ENABLE_68HC08
  { "68hc08", CPU_TYPE_68HC08, ENDIAN_BIG, 1, 1, 0, 0, parse_instruction_68hc08, list_output_68hc08, disasm_range_68hc08, NULL },
#endif
#ifdef ENABLE_680X0
  { "680x0", CPU_TYPE_680X0, ENDIAN_BIG, 1, 1, 0, 1, parse_instruction_680x0, list_output_680x0, disasm_range_680x0, NULL },
#endif
#ifdef ENABLE_805X
  { "805x", CPU_TYPE_805X, ENDIAN_LITTLE, 1, 0, 0, 0, parse_instruction_805x, list_output_805x, disasm_range_805x, NULL },
#endif
#ifdef ENABLE_ARM
  { "arm", CPU_TYPE_ARM, ENDIAN_LITTLE, 1, 0, 0, 0, parse_instruction_arm, list_output_arm, disasm_range_arm, NULL },
#endif
#ifdef ENABLE_AVR8
  { "avr8", CPU_TYPE_AVR8, ENDIAN_LITTLE, 2, 0, 0, 0, parse_instruction_avr8, list_output_avr8, disasm_range_avr8, simulate_init_avr8 },
#endif
#ifdef ENABLE_DSPIC
...
#endif
#ifdef ENABLE_MSP430
  { "msp430", CPU_TYPE_MSP430, ENDIAN_LITTLE, 1, 0, 0, 0, parse_instruction_msp430, list_output_msp430, disasm_range_msp430, simulate_init_msp430 },
  { "msp430x", CPU_TYPE_MSP430X, ENDIAN_LITTLE, 1, 0, 0, 0, parse_instruction_msp430, list_output_msp430x, disasm_range_msp430x, simulate_init_msp430},
#endif
#ifdef ENABLE_DSPIC
  { "pic24", CPU_TYPE_PIC24, ENDIAN_LITTLE, 2, 0, 0, 0, parse_instruction_dspic, list_output_dspic, disasm_range_dspic, NULL },
#endif
  ...
  { "tms1000", CPU_TYPE_TMS1000, ENDIAN_LITTLE, 1, 0, 0, 0, parse_instruction_tms1000, list_output_tms1000, disasm_range_tms1000, NULL },
  { "tms1100", CPU_TYPE_TMS1100, ENDIAN_LITTLE, 1, 0, 0, 0, parse_instruction_tms1100, list_output_tms1100, disasm_range_tms1100, NULL },
#endif
#ifdef ENABLE_TMS9900
  { "tms9900", CPU_TYPE_TMS9900, ENDIAN_BIG, 1, 0, 0, 0, parse_instruction_tms9900, list_output_tms9900, disasm_range_tms9900, simulate_init_tms9900 },
#endif
#ifdef ENABLE_Z80
  { "z80", CPU_TYPE_Z80, ENDIAN_LITTLE, 1, 0, 1, 0, parse_instruction_z80, list_output_z80, disasm_range_z80, simulate_init_z80 },
#endif
  { NULL },
};
