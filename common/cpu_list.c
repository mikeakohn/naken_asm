...
{
#ifdef ENABLE_65XX
  { "65xx", CPU_TYPE_65XX, ENDIAN_LITTLE, 1, 1, 0, parse_instruction_65xx, list_output_65xx, disasm_range_65xx, simulate_init_65xx },
#endif
#ifdef ENABLE_680X
  { "680x", CPU_TYPE_680X, ENDIAN_BIG, 1, 1, 0, parse_instruction_680x, list_output_680x, disasm_range_680x, NULL },
#endif
#ifdef ENABLE_68HC08
  { "68hc08", CPU_TYPE_68HC08, ENDIAN_BIG, 1, 1, 0, parse_instruction_68hc08, list_output_68hc08, disasm_range_68hc08, NULL },
#endif
#ifdef ENABLE_680X0
  { "680x0", CPU_TYPE_680X0, ENDIAN_BIG, 1, 1, 0, parse_instruction_680x0, list_output_680x0, disasm_range_680x0, NULL },
#endif
#ifdef ENABLE_805X
  { "805x", CPU_TYPE_805X, ENDIAN_LITTLE, 1, 0, 0, parse_instruction_805x, list_output_805x, disasm_range_805x, NULL },
#endif
#ifdef ENABLE_ARM
  ...
  { "powerpc", CPU_TYPE_POWERPC, ENDIAN_BIG, 1, 0, 0, parse_instruction_powerpc, list_output_powerpc, disasm_range_powerpc, NULL },
#endif
#ifdef ENABLE_STM8
  { "stm8", CPU_TYPE_STM8, ENDIAN_LITTLE, 1, 1, 0, parse_instruction_stm8, list_output_stm8, disasm_range_stm8, NULL },
#endif
#ifdef ENABLE_THUMB
  { "thumb", CPU_TYPE_THUMB, ENDIAN_LITTLE, 1, 0, 0, parse_instruction_thumb, list_output_thumb, disasm_range_thumb, NULL },
#endif
#ifdef ENABLE_TMS1000
  { "tms1000", CPU_TYPE_TMS1000, ENDIAN_LITTLE, 1, 0, 0, parse_instruction_tms1000, list_output_tms1000, disasm_range_tms1000, NULL },
