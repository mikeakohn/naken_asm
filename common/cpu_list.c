...
#endif
#ifdef ENABLE_MIPS
  { "mips", CPU_TYPE_MIPS32, ENDIAN_LITTLE, 1, 0, 0, 0, parse_instruction_mips, NULL, list_output_mips, disasm_range_mips, simulate_init_mips },
  { "mips32", CPU_TYPE_MIPS32, ENDIAN_LITTLE, 1, 0, 0, 0, parse_instruction_mips, NULL, list_output_mips, disasm_range_mips, simulate_init_mips },
#endif
#ifdef ENABLE_MSP430
