...
struct _table_680x0 table_680x0[] =
{
  ...
  { "asl", 0xe1c0, 0xffc0, OP_SHIFT_EA, 0, MODE_DN|MODE_AN|MODE_D16_PC|MODE_D8_PC_XN, 0, 0 },
  { "asl", 0xe100, 0xf118, OP_SHIFT, 0, 0, 0, 0 },
  { "asr", 0xe0c0, 0xffc0, OP_SHIFT_EA, 0, MODE_DN|MODE_AN|MODE_D16_PC|MODE_D8_PC_XN, 0, 0 },
  { "asr", 0xe000, 0xf118, OP_SHIFT, 0, 0, 0, 0 },
  { "bchg", 0x0140, 0xf1c0, OP_REG_EA_NO_SIZE, 0, MODE_AN|MODE_D16_PC|MODE_D8_PC_XN, OMIT_W, 0 },
  { "bchg", 0x0840, 0xffc0, OP_EXTRA_IMM_EA, 0, MODE_AN|MODE_D16_PC|MODE_D8_PC_XN, OMIT_W, 0 },
  { "bclr", 0x0180, 0xf1c0, OP_REG_EA_NO_SIZE, 0, MODE_AN|MODE_D16_PC|MODE_D8_PC_XN, OMIT_W, 0 },
  { "bclr", 0x0880, 0xffc0, OP_EXTRA_IMM_EA, 0, MODE_AN|MODE_D16_PC|MODE_D8_PC_XN, OMIT_W, 0 },
  { "bkpt", 0x4848, 0xfff8, OP_VECTOR3, 0, 0, NO_SIZE, 0 },
  { "bsr", 0x6100, 0xff00, OP_BRANCH, 0, 0, 0, 0 },
  { "bra", 0x6000, 0xff00, OP_BRANCH, 0, 0, 0, 0 },
  { "bset", 0x01c0, 0xf1c0, OP_REG_EA_NO_SIZE, 0, MODE_AN|MODE_D16_PC|MODE_D8_PC_XN, OMIT_W, 0 },
  { "bset", 0x08c0, 0xffc0, OP_EXTRA_IMM_EA, 0, MODE_AN|MODE_D16_PC|MODE_D8_PC_XN, OMIT_W, 0 },
  ...
  { "eori", 0x0900, 0xff00, OP_IMMEDIATE, 0, MODE_AN|MODE_D16_PC|MODE_D8_PC_XN, 0, 0 },
  ...
  { "lsl", 0xe3c0, 0xffc0, OP_SHIFT_EA, 0, MODE_DN|MODE_AN|MODE_D16_PC|MODE_D8_PC_XN, 0, 0 },
  { "lsl", 0xe108, 0xf118, OP_SHIFT, 0, 0, 0 },
  { "lsr", 0xe2c0, 0xffc0, OP_SHIFT_EA, 0, MODE_DN|MODE_AN|MODE_D16_PC|MODE_D8_PC_XN, 0, 0 },
  { "lsr", 0xe008, 0xf118, OP_SHIFT, 0, 0, 0, 0 },
  { "move", 0x0000, 0xc000, OP_MOVE, 0, MODE_AN|MODE_D16_PC|MODE_D8_PC_XN, 0, 0 },
  { "move", 0x42c0, 0xffc0, OP_MOVE_FROM_CCR, 0, MODE_AN|MODE_D16_PC|MODE_D8_PC_XN, OMIT_B|OMIT_L, 0 },
  { "move", 0x44c0, 0xffc0, OP_MOVE_TO_CCR, MODE_AN, 0, OMIT_B|OMIT_L, 0 },
  { "move", 0x40c0, 0xffc0, OP_MOVE_FROM_SR, 0, MODE_AN|MODE_D16_PC|MODE_D8_PC_XN, OMIT_B|OMIT_L, 0 },
  { "movea", 0x0040, 0xc1c0, OP_MOVEA, 0, 0, OMIT_B, 0 },
  { "movem", 0x4880, 0xfb80, OP_MOVEM, MODE_DN|MODE_AN|MODE_AN_N|MODE_IMM, MODE_DN|MODE_AN|MODE_AN_P|MODE_IMM|MODE_D16_PC|MODE_D8_PC_XN, OMIT_B, 0 },
  ...
  { "rol", 0xe7c0, 0xffc0, OP_SHIFT_EA, 0, MODE_DN|MODE_AN|MODE_D16_PC|MODE_D8_PC_XN, 0, 0  },
  { "rol", 0xe118, 0xf118, OP_SHIFT, 0, 0, 0, 0 },
  { "ror", 0xe6c0, 0xffc0, OP_SHIFT_EA, 0, MODE_DN|MODE_AN|MODE_D16_PC|MODE_D8_PC_XN, 0, 0 },
  { "ror", 0xe018, 0xf118, OP_SHIFT, 0, 0, 0, 0 },
  { "roxl", 0xe5c0, 0xffc0, OP_ROX_MEM, 0, MODE_DN|MODE_AN|MODE_D16_PC|MODE_D8_PC_XN, 0, 0 },
  { "roxl", 0xe130, 0xf138, OP_ROX, 0, 0, 0, 0 },
  { "roxr", 0xe4c0, 0xffc0, OP_ROX_MEM, 0, MODE_DN|MODE_AN|MODE_D16_PC|MODE_D8_PC_XN, 0, 0 },
