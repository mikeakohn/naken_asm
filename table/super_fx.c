...
struct _table_super_fx table_super_fx[] =
{
  ...
  { "stb",   0x30, 1, 0xf0, OP_ATREG,   0xffff },
  ...
  { "add",   0x50, 2, 0xff, OP_N,       0 },
  { "sub",   0x60, 2, 0xff, OP_N,       0 },
  { "and",   0x70, 2, 0xff, OP_N,       0 },
  { "mult",  0x80, 2, 0xff, OP_N,       0 },
  { "sms",   0xa0, 2, 0xf0, OP_ATYY_REG,0xffff },
  { "or",    0xc0, 2, 0xff, OP_N,       0 },
  { "ramb",  0xdf, 2, 0xff, OP_NONE,    0 },
  { "getbl", 0xef, 2, 0xff, OP_NONE,    0 },
  { "sm",    0xf0, 2, 0xf0, OP_ATXX_REG,0xffff },
  { "adc",   0x50, 3, 0xff, OP_N,       0 },
  { "cmp",   0x60, 3, 0xf0, OP_REG,     0xffff },
  { "bic",   0x70, 3, 0xff, OP_N,       0 },
  { "umult", 0x80, 3, 0xff, OP_N,       0 },
  { "xor",   0xc0, 3, 0xff, OP_N,       0 },
