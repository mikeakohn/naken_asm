...
struct _table_super_fx table_super_fx[] =
{
  ...
  { "bge",   0x06, 0, 0xff, OP_OFFSET,  0 },
  { "blt",   0x07, 0, 0xff, OP_OFFSET,  0 },
  ...
  { "ibt",   0xa0, 0, 0xf0, OP_REG_NUM, 0xffff },
  ...
  { "iwt",   0xf0, 0, 0xf0, OP_REG_WORD,0xffff },
  { "stb",   0x30, 1, 0xf0, OP_REG,     0xffff },
  { "ldb",   0x40, 1, 0xf0, OP_REG,     0xafff },
  { "rpix",  0x4c, 1, 0xff, OP_NONE,    0 },
  { "cmode", 0x4e, 1, 0xff, OP_NONE,    0 },
  { "adc",   0x50, 1, 0xf0, OP_REG,     0xffff },
  { "sbc",   0x60, 1, 0xf0, OP_REG,     0xffff },
  { "bic",   0x70, 1, 0xf0, OP_REG,     0xffff },
  { "umult", 0x80, 1, 0xf0, OP_REG,     0xffff },
  { "div2",  0x96, 1, 0xff, OP_NONE,    0 },
  { "ljmp",  0x90, 1, 0xff, OP_REG,     0x7fbf },
  { "lmult", 0x9f, 1, 0xff, OP_NONE,    0 },
  { "lms",   0xa0, 1, 0xf0, OP_REG_SMEM,0xffff },
  { "xor",   0xc0, 1, 0xf0, OP_REG,     0xffff },
  { "getbh", 0xef, 1, 0xff, OP_NONE,    0 },
  { "lm",    0xf0, 1, 0xf0, OP_REG_MEM, 0xffff },
  { "add",   0x50, 2, 0xff, OP_NUM,     0 },
  { "sub",   0x60, 2, 0xff, OP_NUM,     0 },
  { "and",   0x70, 2, 0xff, OP_NUM,     0 },
  { "mult",  0x80, 2, 0xff, OP_NUM,     0 },
  { "sms",   0xa0, 2, 0xf0, OP_MEM_REG, 0xffff },
  { "or",    0xc0, 2, 0xff, OP_NUM,     0 },
  { "ramb",  0xdf, 2, 0xff, OP_NONE,    0 },
  { "getbl", 0xef, 2, 0xff, OP_NONE,    0 },
  { "sm",    0xf0, 2, 0xf0, OP_SMEM_REG,0xffff },
  { "adc",   0x50, 3, 0xff, OP_NUM,     0 },
  { "cmp",   0x60, 3, 0xf0, OP_REG,     0xffff },
  { "bic",   0x70, 3, 0xff, OP_NUM,     0 },
  { "umult", 0x80, 3, 0xff, OP_NUM,     0 },
  { "xor",   0xc0, 3, 0xff, OP_NUM,     0 },
