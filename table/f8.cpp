...
struct _table_f8 table_f8[] = {
  ...
  { "lr",   0x02, 0xfc, F8_OP_A_DPCHR, 4,  4 },
  { "lr",   0x11, 0xff, F8_OP_H_DCO,  16, 16 },
  { "lr",   0x0e, 0xff, F8_OP_Q_DCO,  16, 16 },
  { "lr",   0x10, 0xff, F8_OP_DCO_H,  16, 16 },
  { "lr",   0x0f, 0xff, F8_OP_DCO_Q,  16, 16 },
  { "lr",   0x08, 0xff, F8_OP_K_PC1,  16, 16 },
  { "lr",   0x09, 0xff, F8_OP_PC1_K,  16, 16 },
  { "lr",   0x0d, 0xff, F8_OP_PCO_Q,  16, 16 },
  { "pk",   0x0c, 0xff, F8_OP_NONE,   16, 16 },

  // Secondary memory reference (scratchpad) opcodes.
  { "as",   0xc0, 0xff, F8_OP_R,       4,  4 },
  { "asd",  0xd0, 0xff, F8_OP_R,       8,  8 },
  { "ns",   0xf0, 0xff, F8_OP_R,       4,  4 },
  { "xs",   0xe0, 0xff, F8_OP_R,       4,  4 },
  { "ds",   0x30, 0xff, F8_OP_R,       6,  6 },
