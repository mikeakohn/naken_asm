...
struct _table_pdk14 table_pdk14[] =
{
  ...
  { "izsn",    0x0062, 0xffff, OP_A,    1, 1 },
  { "dzsn",    0x0063, 0xffff, OP_A,    1, 1 },
  ...
  { "izsn",    0x1100, 0xff80, OP_M,    1, 1 },
  { "dzsn",    0x1180, 0xff80, OP_M,    1, 1 },
  ...
  { "ceqsn",   0x1700, 0xff80, OP_A_M,  1, 1 },
  { "cneqsn",  0x1780, 0xff80, OP_A_M,  1, 1 },
  // Bit operations with IO.
  { "t0sn",    0x1800, 0xfe00, OP_IO_N, 1, 1 },
  { "t1sn",    0x1a00, 0xfe00, OP_IO_N, 1, 1 },
  { "set0",    0x1c00, 0xfe00, OP_IO_N, 1, 1 },
  { "set1",    0x1e00, 0xfe00, OP_IO_N, 1, 1 },
  // Bit operations with memory.
  { "t0sn",    0x2000, 0xfe00, OP_M_N,  1, 1 },
  { "t1sn",    0x2200, 0xfe00, OP_M_N,  1, 1 },
  ...
  { "ceqsn",   0x2a00, 0xff00, OP_A_K,  1, 1 },
  { "cneqsn",  0x2b00, 0xff00, OP_A_K,  1, 1 },
