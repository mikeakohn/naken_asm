...
struct _table_stm8_opcodes table_stm8_opcodes[] = {
  ...
  { STM8_SUBW, OP_NUMBER16, 0x72, 0xa2, OP_REG_X, OP_NONE, 2,2, ST7_NO },
  { STM8_SUBW, OP_ADDRESS16, 0x72, 0xb2, OP_REG_X, OP_NONE, 2,2, ST7_NO },
  { STM8_SUBW, OP_OFFSET8_INDEX_SP, 0x72, 0xf2, OP_REG_X, OP_NONE, 2,2, ST7_NO },
  // SWAP
  // FIXME: Again ($10,SP) is marked as ST7.
