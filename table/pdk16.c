...
struct _table_pdk16 table_pdk16[] =
{
  ...
  { "ceqsn",   0x1a00, 0xff00, OP_A_K,  1, 1 },
  { "cneqsn",  0x1b00, 0xff00, OP_A_K,  1, 1 },
  ...
  { "t0sn",    0x2000, 0xfe00, OP_IO_N, 1, 1 },
  { "t1sn",    0x2200, 0xfe00, OP_IO_N, 1, 1 },
  { "set0",    0x2400, 0xfe00, OP_IO_N, 1, 1 },
  { "set1",    0x2600, 0xfe00, OP_IO_N, 1, 1 },
  { "tog",     0x2800, 0xfe00, OP_IO_N, 1, 1 },
  { "wait0",   0x2a00, 0xfe00, OP_IO_N, 1, 1 },
  { "wait1",   0x2c00, 0xfe00, OP_IO_N, 1, 1 },
  { "swapc",   0x2e00, 0xfe00, OP_IO_N, 1, 1 },
  // Operations with A and memory.
  { "nmov",    0x3000, 0xfe00, OP_A_M9, 1, 1 },
  { "nmov",    0x3200, 0xfe00, OP_M9_A, 1, 1 },
  { "nadd",    0x3400, 0xfe00, OP_A_M9, 1, 1 },
  { "nadd",    0x3600, 0xfe00, OP_M9_A, 1, 1 },
  { "ceqsn",   0x3800, 0xfe00, OP_A_M9, 1, 1 },
  { "ceqsn",   0x3a00, 0xfe00, OP_M9_A, 1, 1 },
  ...
  { "izsn",    0x6400, 0xfe00, OP_M9,   1, 1 },
  { "dzsn",    0x6600, 0xfe00, OP_M9,   1, 1 },
  ...
  { "t0sn",    0x8000, 0xf000, OP_M_N,  1, 1 },
  { "t1sn",    0x9400, 0xf000, OP_M_N,  1, 1 },
