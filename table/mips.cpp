...
struct _mips_instr mips_r_table[] =
{
  ...
  { "div", { MIPS_OP_RS, MIPS_OP_RT, MIPS_OP_NONE }, 0x1a, 2, MIPS_I | MIPS_NOT_RSP },
  { "divu", { MIPS_OP_RS, MIPS_OP_RT, MIPS_OP_NONE }, 0x1b, 2, MIPS_I | MIPS_NOT_RSP },
  ...
  { "mfhi", { MIPS_OP_RD, MIPS_OP_NONE, MIPS_OP_NONE }, 0x10, 1, MIPS_I | MIPS_NOT_RSP },
  { "mflo", { MIPS_OP_RD, MIPS_OP_NONE, MIPS_OP_NONE }, 0x12, 1, MIPS_I | MIPS_NOT_RSP },
  { "movn", { MIPS_OP_RD, MIPS_OP_RS, MIPS_OP_RT }, 0x0b, 3, MIPS_IV | MIPS_32 },
  { "movz", { MIPS_OP_RD, MIPS_OP_RS, MIPS_OP_RT }, 0x0a, 3, MIPS_IV | MIPS_32 },
  { "mthi", { MIPS_OP_RS, MIPS_OP_NONE, MIPS_OP_NONE }, 0x11, 1, MIPS_I | MIPS_NOT_RSP },
  { "mtlo", { MIPS_OP_RS, MIPS_OP_NONE, MIPS_OP_NONE }, 0x13, 1, MIPS_I | MIPS_NOT_RSP },
...
struct _mips_instr mips_i_table[] =
{
  ...
  { "ldl", { MIPS_OP_RT, MIPS_OP_IMMEDIATE_RS, MIPS_OP_NONE }, 0x1a, 2, MIPS_III | MIPS_NOT_RSP },
  { "ldr", { MIPS_OP_RT, MIPS_OP_IMMEDIATE_RS, MIPS_OP_NONE }, 0x1b, 2, MIPS_III | MIPS_NOT_RSP },
  ...
  { "lwl", { MIPS_OP_RT, MIPS_OP_IMMEDIATE_RS, MIPS_OP_NONE }, 0x22, 2, MIPS_I | MIPS_NOT_RSP },
  { "lwr", { MIPS_OP_RT, MIPS_OP_IMMEDIATE_RS, MIPS_OP_NONE }, 0x26, 2, MIPS_I  | MIPS_NOT_RSP},
  ...
  { "slti", { MIPS_OP_RT, MIPS_OP_RS, MIPS_OP_IMMEDIATE_SIGNED }, 0x0a, 3, MIPS_I },
  { "sltiu", { MIPS_OP_RT, MIPS_OP_RS, MIPS_OP_IMMEDIATE }, 0x0b, 3, MIPS_I },
  { "sw", { MIPS_OP_RT, MIPS_OP_IMMEDIATE_RS, MIPS_OP_NONE }, 0x2b, 2, MIPS_I },
  { "swl", { MIPS_OP_RT, MIPS_OP_IMMEDIATE_RS, MIPS_OP_NONE }, 0x2a, 2, MIPS_I | MIPS_NOT_RSP },
  { "swr", { MIPS_OP_RT, MIPS_OP_IMMEDIATE_RS, MIPS_OP_NONE }, 0x2e, 2, MIPS_I | MIPS_NOT_RSP },
  { "swc1", { MIPS_OP_FT, MIPS_OP_IMMEDIATE_RS, MIPS_OP_NONE }, 0x39, 2, MIPS_I | MIPS_NOT_RSP },
...
struct _mips_other mips_other[] =
{
  ...
  { "bc0f", { MIPS_OP_LABEL, MIPS_OP_NONE, MIPS_OP_NONE }, 1, 0x41000000, 0xffff0000, MIPS_I | MIPS_NOT_RSP },
  { "bc0fl", { MIPS_OP_LABEL, MIPS_OP_NONE, MIPS_OP_NONE }, 1, 0x41020000, 0xffff0000, MIPS_I | MIPS_NOT_RSP },
  { "bc0t", { MIPS_OP_LABEL, MIPS_OP_NONE, MIPS_OP_NONE }, 1, 0x41010000, 0xffff0000, MIPS_I | MIPS_NOT_RSP },
  { "bc0tl", { MIPS_OP_LABEL, MIPS_OP_NONE, MIPS_OP_NONE }, 1, 0x41030000, 0xffff0000, MIPS_I | MIPS_NOT_RSP },
  { "bc2f", { MIPS_OP_LABEL, MIPS_OP_NONE, MIPS_OP_NONE }, 1, 0x49000000, 0xffff0000, MIPS_I | MIPS_NOT_RSP },
  { "bc2fl", { MIPS_OP_LABEL, MIPS_OP_NONE, MIPS_OP_NONE }, 1, 0x49020000, 0xffff0000, MIPS_I | MIPS_NOT_RSP },
  { "bc2t", { MIPS_OP_LABEL, MIPS_OP_NONE, MIPS_OP_NONE }, 1, 0x49010000, 0xffff0000, MIPS_I | MIPS_NOT_RSP },
  { "bc2tl", { MIPS_OP_LABEL, MIPS_OP_NONE, MIPS_OP_NONE }, 1, 0x49030000, 0xffff0000, MIPS_I | MIPS_NOT_RSP },
  ...
  { "mult", { MIPS_OP_RS, MIPS_OP_RT, MIPS_OP_NONE }, 2, 0x00000018, 0xfc00ffff, MIPS_I | MIPS_NOT_RSP },
  ...
  { "multu", { MIPS_OP_RS, MIPS_OP_RT, MIPS_OP_NONE }, 2, 0x00000019, 0xfc00ffff, MIPS_I | MIPS_NOT_RSP },
  ...
  // Trap instructions
  { "syscall", { MIPS_OP_OPTIONAL, MIPS_OP_NONE, MIPS_OP_NONE }, 1, 0x0000000c, 0xfc00003f, MIPS_I | MIPS_NOT_RSP },
  ...
  { "bc1f", { MIPS_OP_LABEL, MIPS_OP_NONE, MIPS_OP_NONE }, 1, 0x45000000, 0xffff0000, MIPS_I | MIPS_NOT_RSP },
  { "bc1fl", { MIPS_OP_LABEL, MIPS_OP_NONE, MIPS_OP_NONE }, 1, 0x45020000, 0xffff0000, MIPS_II | MIPS_NOT_RSP },
  { "bc1t", { MIPS_OP_LABEL, MIPS_OP_NONE, MIPS_OP_NONE }, 1, 0x45010000, 0xffff0000, MIPS_I | MIPS_NOT_RSP },
  { "bc1tl", { MIPS_OP_LABEL, MIPS_OP_NONE, MIPS_OP_NONE }, 1, 0x45030000, 0xffff0000, MIPS_II | MIPS_NOT_RSP },
