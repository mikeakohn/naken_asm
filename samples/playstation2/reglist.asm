;; Draw a triangle using a reglist GIF packet instead of a packed
;; packet (like triangle.asm is).
...
draw_triangle:
  ...
  dc64 GIF_TAG(3, 1, 1, PRIM_TRIANGLE, FLG_REGLIST, 2), (REG_RGBAQ|(REG_XYZ2<<4))
  dc64 SETREG_RGBAQ(255,0,0,0,0x3f80_0000)
  dc64 SETREG_XYZ2(1800 << 4, 2000 << 4, 128)
  dc64 SETREG_RGBAQ(0,255,0,0,0x3f80_0000)
  dc64 SETREG_XYZ2(1800 << 4, 2010 << 4, 128)
  dc64 SETREG_RGBAQ(0,0,255,0,0x3f80_0000)
  dc64 SETREG_XYZ2(1900 << 4, 2010 << 4, 128)
draw_triangle_end:
...
red_screen:
  ...
  dc64 6, REG_PRIM 
  dc64 0x3f80_0000_0000_0080, REG_RGBAQ  ; Background RGBA
