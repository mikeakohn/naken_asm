...
black_screen:
  ...
  dc64 SETREG_FRAME(0, 640 / 64, FMT_PSMCT32, 0), REG_FRAME_1
  ...
  dc64 SETREG_COLCLAMP(1), REG_COLCLAMP
  dc64 SETREG_DTHE(0), REG_DTHE
  dc64 0x70000, REG_TEST_1 
  dc64 0x30000, REG_TEST_1 
  dc64 SETREG_PRIM(PRIM_SPRITE, 0, 0, 0, 0, 0, 0, 0, 1), REG_PRIM
...
draw_square:
  ...
  ;dc64 SETREG_ST(1.0,0.0), REG_ST
  dc64 SETREG_ST(0x3f80_0000,0), REG_ST
  dc64 SETREG_RGBAQ(100,100,100,255,0x3f80_0000), REG_RGBAQ
  dc64 SETREG_XYZ2(1800 << 4, 1950 << 4, 128), REG_XYZ2
  ;dc64 SETREG_ST(0.0,0.0), REG_ST
  dc64 SETREG_ST(0,0), REG_ST
  dc64 SETREG_RGBAQ(100,100,100,255,0x3f80_0000), REG_RGBAQ
  dc64 SETREG_XYZ2(1800 << 4, 2010 << 4, 128), REG_XYZ2
  ;dc64 SETREG_ST(0.0,1.0), REG_ST
  dc64 SETREG_ST(0,0x3f80_0000), REG_ST
  dc64 SETREG_RGBAQ(100,100,100,255,0x3f80_0000), REG_RGBAQ
  dc64 SETREG_XYZ2(2100 << 4, 2010 << 4, 128), REG_XYZ2
  ;dc64 SETREG_ST(1.0,1.0), REG_ST
  dc64 SETREG_ST(0x3f80_0000,0x3f80_0000), REG_ST
  dc64 SETREG_RGBAQ(100,100,100,255,0x3f80_0000), REG_RGBAQ
